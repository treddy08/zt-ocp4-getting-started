...
[source,asciidoc]
----
image::demo-timing-chart.png[link=self,window=blank,align="center",width=600,title="Demo Timing Structure"]
----
...
[source,asciidoc]
----
image::demo-opening.png[link=self,window=blank,align="left",width=300,title="Opening - Business Context"]
image::demo-technical.png[link=self,window=blank,align="center",width=300,title="Technical Demo - Core Features"]
image::demo-closing.png[link=self,window=blank,align="right",width=300,title="Closing - Value Recap"]
----
