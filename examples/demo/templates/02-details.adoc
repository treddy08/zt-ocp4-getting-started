...
* Discuss background and introduce use case
...
Add a table with the list of credentials here. They will also be included in the **Show** sections, but include them here for convenience.
