...
image::executive-dashboard.png[link=self,window=blank,align="center",width=700,title="Executive Dashboard - Business Metrics"]

// For technical audience  
image::technical-details.png[link=self,window=blank,align="center",width=600,title="Technical Details - Implementation Steps"]

// For security audience
image::security-compliance.png[link=self,window=blank,align="center",width=600,title="Security & Compliance - Policy Enforcement"]
----
...
[source,asciidoc]
----
image::screenshot.png[link=self,window=blank,align="center",width=500]
----
...
[source,asciidoc]
----
image::demo-flow.png[link=self,window=blank,align="center",width=600,title="Demo Flow Diagram"]
----
...
[source,asciidoc]
----
image::step1.png[link=self,window=blank,align="left",width=250,title="Step 1"]
image::step2.png[link=self,window=blank,align="center",width=250,title="Step 2"]  
image::step3.png[link=self,window=blank,align="right",width=250,title="Step 3"]
----
