...
on OpenShift. Using the local directory would relieve you from having Maven or any of the Java toolchain on your local machine.
...
[source,bash,subs="+macros,+attributes"]
----
https://{openshift_cluster_ingress_domain}:30713
----
...
----
http://mlbparks-{user_project}.{openshift_cluster_ingress_domain}/ws/info/
----
