...
From the
link:{openshift_docs_url}/html/building_applications/application-health[Application
...
image::nationalparks-application-health-menu.png[Add Health Checks Menu,link=self,window=blank]
...
image::nationalparks-application-health-settings.png[Health Check Settings,link=self,window=blank]
...
image::nationalparks-application-health-add.png[Add Health Checks,link=self,window=blank]
